        ...
        <div className="relative min-h-screen bg-[#030712] text-slate-200 font-sans">
            ...
            <div className="relative z-10 flex items-start">
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-8 pb-20">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-sm font-black text-white mb-2">
                                        One profile. Multiple collections.
                                    </h3>

                                    <p className="text-sm text-slate-500 leading-relaxed">

                                        Your profile acts as the central identity for
                        ...
                        >
                            ...
                            {/* <section className="pt-4 pb-8">
                                ...
                                {authLoading == false && hasProfile == true ?
                                    <div className="mb-8 rounded-2xl border border-yellow-500/20 bg-yellow-500/[0.06] px-5 py-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-sm font-medium text-yellow-300">
                                                You already have a profile. Redirecting to your profile...
                                            </p>
