...
import { IpfsImage } from "../../lib/marketplace"
...
const VerificationControl = ({ isVerified, onActivateClick, compact = false }) => {
    ...
    if (isVerified) {
        ...
        return (
            ...
            <span
                ...
                `}
            >
                <BadgeCheck size={compact ? 12 : 14} className="text-cyan-400" />
                Active
            </span>
    ...
    return (
        ...
        <button
            ...
            className={`
                ...
                font-black uppercase tracking-wider
                hover:text-cyan-300 hover:border-cyan-400/30 hover:bg-cyan-500/[0.06]
                transition-all
                ${compact ? 'px-2 py-0.5 text-[9px]' : 'px-3 py-1.5 text-[10px]'}
            `}
        >
            ...
            <div className="relative z-10 flex items-start">
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 py-6 lg:py-10">
                        ...
                        <section className="relative h-[200px] md:h-[280px] rounded-[28px] overflow-hidden border border-white/[0.08] bg-[#02050E]">
                        ...
                        <section className="relative px-2 md:px-4">

                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 -mt-14 md:-mt-16 relative z-10">

                                <div className="flex flex-col sm:flex-row sm:items-end gap-6">

                                    <div className="relative w-28 h-28 md:w-36 md:h-36 rounded-[28px] p-[2px] bg-gradient-to-br from-emerald-400 via-blue-500 to-purple-500 shadow-[0_20px_60px_rgba(16,185,129,0.15)]">

                                        <div className="w-full h-full rounded-[26px] bg-[#07110F] overflow-hidden flex items-center justify-center">
                                            ...
                                            {user.logo ? (
                                                ...
                                                <User2 size={40} className="text-emerald-300" />
                                            )}
                            ...
                            <p className="max-w-2xl text-slate-400 leading-relaxed mt-7 text-sm md:text-base">
                                {user.bio}
                            </p>
                        ...
                        {/* ================= STICKY MINI HEADER + TABS ================= */}

                        <div className="sticky top-14 lg:top-0 z-20 mt-8 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 bg-[#030712]/90 backdrop-blur-md border-b border-white/5">

                            <div className="flex items-center gap-3 py-3">

                                <div className="w-8 h-8 rounded-lg overflow-hidden bg-[#07110F] border border-white/10 flex items-center justify-center shrink-0">
                                    ...
                                    {user.logo ? (
                                        ...
                                        <User2 size={14} className="text-emerald-300" />
                                    )}
                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex items-center gap-2 pb-4 text-[10px] font-black uppercase tracking-[0.18em] whitespace-nowrap transition-colors ${
                                                activeTab === tab.id
                                                    ? 'text-white'
                        ...
                        {activeTab === 'overview' && (
                            ...
                            <div className="space-y-10 py-10">
                                ...
                                <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <StatCard icon={Layers} label="Collections" value={profile.totalCollections} accent="blue" />
                                    <StatCard icon={Package} label="Total Assets" value={profile.totalItems} accent="green" />
                                    <StatCard icon={TrendingUp} label="Volume" value={profile.volume} accent="green" />
                                    <StatCard icon={Eye} label="Profile Views" value={profile.views} accent="blue" />
                                        ...
                                        {quickActions.map((action) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className={`absolute top-0 right-0 w-40 h-40 rounded-full blur-[60px] opacity-70 ${actionStyle.glow}`} />

                                                    <div className="relative">

                                                        <div className={`w-13 h-13 rounded-2xl flex items-center justify-center mb-6 border border-white/5 ${actionStyle.icon}`}>
                                                            <Icon size={22} />
                                                        </div>
                                                        ...
                                                        <div className={`flex items-center gap-2 text-xs font-black mt-6 ${actionStyle.text}`}>
                                                            Get Started
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={`h-44 bg-gradient-to-br ${gradients[index % gradients.length]} flex items-center justify-center relative`}>
                                                    ...
                                                    <Image size={38} className="relative text-emerald-300/60" />
                                    ...
                                    >
                                        ...
                                        <div className="w-16 h-16 rounded-2xl bg-emerald-500/5 group-hover:bg-emerald-500/10 flex items-center justify-center mb-6 transition-colors border border-emerald-500/10">
                                            <Plus size={26} className="text-emerald-400" />
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`absolute top-0 right-0 w-72 h-72 blur-[100px] rounded-full ${
                                                    index === 0 ? 'bg-emerald-500/12' : 'bg-blue-500/10'
                                                }`}
                                            />
                                            ...
                                            <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-8">
                                                ...
                                                <div className="flex gap-5">
                                                    ...
                                                    >
                                                        <Rocket size={25} className={index === 0 ? 'text-emerald-400' : 'text-blue-400'} />
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mt-5">
                                                            ...
                                                            <div className="flex justify-between text-xs mb-2">
                                                                <span className="text-slate-600">Mint Progress</span>
                                                                <span className="font-bold text-white">{launchpad.minted}</span>
                                                            </div>
                                                ...
                                                <div className="flex gap-3">
                                                    ...
                                                    <button className="w-11 h-11 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-slate-400 hover:text-emerald-300 hover:border-emerald-500/20 transition-all">
                                                        {launchpad.status === 'Live' ? <Pause size={17} /> : <Play size={17} />}
                                                    </button>
                                    ...
                                    {activities.map((activity, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={`w-12 h-12 shrink-0 rounded-2xl ${style.bg} ${style.border} border flex items-center justify-center`}>
...
const StatCard = ({ icon: Icon, label, value, accent = 'blue' }) => {
    ...
    const styles = {
        blue: { icon: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/10', dot: 'bg-blue-400' },
        purple: { icon: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-purple-500/10', dot: 'bg-purple-400' },
        green: { icon: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/10', dot: 'bg-emerald-400' }
    };
    ...
    return (
        ...
        <div className="group relative overflow-hidden p-5 md:p-6 rounded-2xl border border-white/10 bg-[#02050E]/90 hover:border-emerald-500/20 transition-all">
            ...
            <div className={`absolute -top-10 -right-10 w-24 h-24 rounded-full blur-[50px] opacity-40 ${style.bg}`} />
