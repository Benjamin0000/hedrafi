           ...
           <div className="space-y-6">
              <div className="flex justify-between items-end px-2">
                 <div className="space-y-1">
                    ...
                    <div className="text-xs font-bold text-slate-500">Inventory Liquidity</div>
                 </div>
                 <div className="text-right">
                    <div className="text-[9px] font-black uppercase tracking-widest text-slate-600">Available ℏ</div>
                    <div className="text-md font-mono font-black text-white">{ hbarBalance }</div>
                 </div>
              </div>
              ...
              <div className="relative group/input">
                 ...
                 />
                 <button 
                   onClick={() => setStakeAmount(balance?.formatted || 0) }
                   className="absolute right-4 top-1/2 -translate-y-1/2 px-4 py-2 bg-blue-500/10 text-cyber-blue rounded-xl text-[9px] font-black uppercase tracking-widest border border-blue-500/20 hover:bg-blue-600 hover:text-white transition-all shadow-lg"
                 >
                    MAX
                 </button>
              </div>
           ...
           <div className="space-y-6">
              <div className="flex justify-between items-end px-2">
                 <div className="space-y-1">
                    ...
                    <div className="text-xs font-bold text-slate-500">Release Liquidity</div>
                 </div>
                 <div className="text-right">
                    <div className="text-[9px] font-black uppercase tracking-widest text-slate-600">Your Stake ℏ</div>
                    <div className="text-md font-mono font-black text-white">{userStake.toFixed(2)}</div>
                 </div>
              </div>
              ...
              <div className="relative group/input">
                 ...
                 <button 
                   ...
                   className="absolute right-4 top-1/2 -translate-y-1/2 px-4 py-2 bg-red-500/10 text-red-500 rounded-xl text-[9px] font-black uppercase tracking-widest border border-red-500/20 hover:bg-red-500 hover:text-white transition-all shadow-lg"
                 >
                    MAX
                 </button>
              </div>
            ...
            <div className="relative z-10 space-y-8">
               <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <Sparkles size={18} className="text-cyber-blue" />
