    ...
    return (
        <div className="relative min-h-screen bg-[#030712] overflow-hidden text-slate-200 font-sans">
            ...
            <main className="relative z-10">
                ...
                <section className="px-4 sm:px-6 lg:px-8 pt-28 md:pt-36 pb-24">
                            ...
                            <div className="max-w-2xl">
                                ...
                                <h1 className="text-5xl md:text-6xl lg:text-[4.2rem] font-black tracking-tighter leading-[0.95] text-white">
                                    ...
                                    <span className="bg-gradient-to-r from-emerald-300 via-emerald-400 to-cyan-400 bg-clip-text text-transparent">
                                        Your <span className='animated-gradient-text'>storefront.</span>
                                    </span>
                                ...
                                <p className="text-lg md:text-xl text-slate-400 leading-relaxed mt-7 max-w-xl">
                                    ...
                                    Create your own branded space on HedraFi to showcase,
                                    launch, and sell your digital assets and tokenized
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-500 mt-1">
                                                        Digital Assets • RWA • Collectibles
                                                    </p>
                    ...
                    <div className="container-main">
                        ...
                        <div className="max-w-2xl mb-14">
                            ...
                            <p className="text-slate-500 mt-4 leading-relaxed">
                                Your storefront gives your work a dedicated presence
                                inside the HedraFi ecosystem instead of leaving your
                                assets scattered across individual marketplace listings.
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <FeatureCard
                                ...
                                description="Create a dedicated destination where users can discover your brand, collections, and assets."
                            />
                            ...
                            <FeatureCard
                                ...
                                description="Give your projects a stronger presence within the HedraFi marketplace ecosystem."
                            />

                            <FeatureCard
                                icon={Globe2}
                                title="Reach Buyers"
                                description="Make it easier for collectors and investors to discover what you're offering."
                            />
                    ...
                    <div className="container-main">
                        ...
                        <div className="text-center max-w-2xl mx-auto mb-14">
                            ...
                            <p className="text-slate-500 mt-4">
                                Your storefront is the starting point for turning
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <StepCard
                                ...
                                description="Choose your store name, identity, and basic information."
                            />
                            ...
                            <StepCard
                                ...
                                description="Give your audience one place to discover everything you offer."
                            />
                        ...
                        <div className="relative overflow-hidden rounded-[28px] border border-emerald-500/[0.15] bg-[#030712] px-7 py-16 md:px-16 md:py-20 text-center">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-400 max-w-xl mx-auto mt-5 leading-relaxed">
                                    Create a storefront and give your assets a dedicated
                                    home within the HedraFi ecosystem.
                                </p>
...
const StorePreviewCard = ({ image, title, price }) => {
